  ...
  return (
    <footer className='px-8 py-1 bg-[url("assets/vectors/small_up_shape.svg")] bg-cover'>
      <div className='flex justify-between items-center mx-1 pt-10'>
        <img src='/assets/vectors/Logo.svg' alt="Logo" className='w-[10rem] h-auto p-2' />
      ...
      <div className='flex justify-between items-end mx-3 text-lg'>
        ...
        <p className='p-2'><span className='underline'>Droit d'auteur</span> © <span className='underline'>2024 Tous droits réservés</span></p>
        <p className='p-2'><span className='underline'>Termes</span> & <span className='underline'>Conditions</span></p>
      </div>
    </footer>
  )
}
