...
const SearchHeader = ({ setSearchTerm, handleReset }) => {
  return (
    <header className='relative px-8 pt-7 pb-14 mb-10 bg-[url("assets/vectors/small_bottom_shape.svg")] bg-bottom bg-cover'>
      ...
      <SearchBar setSearchTerm={setSearchTerm} handleReset={handleReset} />
    </header>
  );
};
